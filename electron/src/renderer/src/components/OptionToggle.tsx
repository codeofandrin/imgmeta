...
export default function OptionToggle({ className, id, title, option1, option2, isOnOff }: OptionTogglePropsType) {
  return (
      ...
      <div className="w-full mt-2">
        <label className="flex items-center cursor-pointer">
          ...
          <div className="shrink-0">
            ...
            <div className={`relative w-11 h-6 ${isOnOff ? "bg-gray-700" : "bg-blue-600"} 
